#GENERAZIONE GRAFICI SCARTO ED ERRORE QUADRATICO MEDIO, SU ORIZZONTE TEMPORALE MENSILE, MMS ECM CI5 CI2
...
get_save_path <- function(raggr) { #GET PATH COMPLETO PER SALVATAGGIO GRAFICI
    if (raggr==1){
        ritorno=paste(imgsave_path,"/",regione,"_T",t,"_",q,"_ST.png",sep="")
    }else{
